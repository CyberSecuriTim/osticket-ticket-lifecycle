...
<p>
  ...
  - NOTE: This project requires a working installation of the osTicket help-desk ticketing software and it is strongly recommended to perform the appropriate post-installation 
    configurations.
...
![image](https://github.com/user-attachments/assets/a443bbe0-3b33-4ecf-bebc-acf6884ac87c)
   ...
   - Fill out the contact information for the user who is creating the ticket.
   ...
   - Lastly, feel free to elaborate on the nature of the issue and exactly what seems to be wrong in the description box below the "Issue Summary" field. The more information that you 
     can provide to the Help Desk Agents the more accurately they can diagnose and resolve the issue for the user. 
  ...
  - Repeat the steps outlined above to create two more tickets as one of the created end users:
...
<p>
 ...
 - Login as one of your created  help desk agents (specifically one of them with access to the "System Administrators" Department so that you can view all 
  ...
  - Then navigate to the Agent panel (if not brought there automatically by the link)
...
<p>
   ...
   - If you are finished with the project and would like to stop being charged entirely for hosting your computing resources 
